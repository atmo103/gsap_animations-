...
const BentoTilt = ({ children, className = ''}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const relativeX = (e.clientX - left) / width;
          ...
          const tiltX = (relativeY - 0.5) * 0.5;
           const tiltY = (relativeX - 0.5) * -0.5;
            ...
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
                        ...
                        an interconnected overlay experience on your world.
                ...
                <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
                    <BentoCard src="videos/feature-1.mp4" title={<>radia<b>n</b>t</>} description="A cross-platform metagame app,
turning your activities across Web2 and Web3 games into a rewarding adventure."  />
                </BentoTilt>

                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                        <BentoCard src="videos/feature-2.mp4" title={<>Zig<b>m</b>a</>} description="An anime and gaming-inspire NTF collection - 
...
<BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
    ...
    <BentoCard src="videos/feature-4.mp4" title={<>Az<b>u</b>l</>} description="A cross-world AI Agent - elevating your
